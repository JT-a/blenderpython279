...
class VIEW3D_MT_view(Menu):
    ...
    def draw(self, context):
        ...
        layout.separator()
        layout.menu("VIEW3D_MT_view_directions", text="Directions")
        ...
        layout.menu("VIEW3D_MT_screen_areas", text="Screen Areas")
...
class VIEW3D_MT_screen_areas(Menu):
    bl_label = "View"
...
class INFO_MT_add(Menu):
    ...
    def draw(self, context):
        ...
        layout.menu("VIEW3D_MT_object_quick_effects", icon = "MOD_PARTICLES")
...
### Edit mesh Specials
class VIEW3D_MT_edit_mesh_special_utils(Menu):
    bl_label = "Utils"
...
class VIEW3D_MT_edit_mesh_specials(Menu):
    ...
    def draw(self, context):
        ...
        layout.menu("VIEW3D_MT_edit_mesh_hide_reveal")
        layout.menu("VIEW3D_MT_edit_mesh_special_utils")
        layout.separator()


class VIEW3D_MT_edit_mesh_hide_reveal(Menu):
    bl_label = "Hide / reveal"
...
class VIEW3D_MT_edit_mesh_vertices(Menu):
    ...
    def draw(self, context):
        ...
        layout.menu("VIEW3D_MT_edit_mesh_fill")
        layout.menu("VIEW3D_MT_edit_mesh_clean")
        layout.menu("VIEW3D_MT_edit_mesh_extrude")
        layout.menu("VIEW3D_MT_edit_mesh_delete")
        ...
        layout.menu("VIEW3D_MT_edit_mesh_vert_rip")
        layout.operator_menu_enum("mesh.separate", "type")
        layout.menu("VIEW3D_MT_edit_mesh_vert_connect")
        layout.menu("VIEW3D_MT_edit_mesh_vert_mark")
        ...
        layout.menu("VIEW3D_MT_edit_mesh_vert_shape")
        layout.separator()
...
class VIEW3D_MT_edit_mesh_vert_mark(Menu):
    bl_label = "Vert Mark"
...
class VIEW3D_MT_edit_mesh_vert_rip(Menu):
    bl_label = "Rip"
...
class VIEW3D_MT_edit_mesh_vert_connect(Menu):
    bl_label = "Connect"
...
class VIEW3D_MT_edit_mesh_vert_shape(Menu):
    bl_label = "Shape"
...
class VIEW3D_MT_edit_mesh_edges(Menu):
    ...
    def draw(self, context):
        ...
        layout.menu("VIEW3D_MT_edit_mesh_edge_loops")
        layout.menu("VIEW3D_MT_edit_mesh_edge_mark")
        layout.menu("VIEW3D_MT_edit_mesh_edge_rotate")

        layout.separator()

        layout.menu("VIEW3D_MT_edit_mesh_freestyle_edge")

        layout.separator()


class VIEW3D_MT_edit_mesh_edge_rotate(Menu):
    bl_label = "Edge Rotate"
...
class VIEW3D_MT_edit_mesh_edge_loops(Menu):
    bl_label = "Edge Loops"
...
class VIEW3D_MT_edit_mesh_edge_mark(Menu):
    bl_label = "Edge Mark"
...
class VIEW3D_MT_edit_mesh_freestyle_edge(Menu):
    bl_label = "Freestyle Face"
...
class VIEW3D_MT_edit_mesh_faces(Menu):
    ...
    def draw(self, context):
        ...
        layout.menu("VIEW3D_MT_edit_mesh_face_rot_uv")

        layout.separator()

        layout.menu("VIEW3D_MT_edit_mesh_freestyle_face")

        layout.separator()

class VIEW3D_MT_edit_mesh_freestyle_face(Menu):
    bl_label = "Freestyle Face"
...
class VIEW3D_MT_edit_mesh_fill(Menu):
    bl_label = "Fill"
...
class VIEW3D_MT_edit_mesh_face_rot_uv(Menu):
    bl_label = "UV Rotate"
...
classes = (
    ...
    VIEW3D_MT_edit_mesh_special_utils,
    VIEW3D_MT_edit_mesh_specials,
    VIEW3D_MT_edit_mesh_hide_reveal,
    VIEW3D_MT_edit_mesh_select_mode,
    VIEW3D_MT_edit_mesh_select_linked,
    VIEW3D_MT_edit_mesh_select_loops,
    VIEW3D_MT_edit_mesh_extrude,
    VIEW3D_MT_edit_mesh_vertices,
    VIEW3D_MT_edit_mesh_vert_mark,
    VIEW3D_MT_edit_mesh_vert_rip,
    VIEW3D_MT_edit_mesh_vert_connect,
    VIEW3D_MT_edit_mesh_vert_shape,
    VIEW3D_MT_edit_mesh_edges,
    VIEW3D_MT_edit_mesh_edge_rotate,
    VIEW3D_MT_edit_mesh_edge_loops,
    VIEW3D_MT_edit_mesh_edge_mark,
    VIEW3D_MT_edit_mesh_freestyle_edge,
    VIEW3D_MT_edit_mesh_faces,
    VIEW3D_MT_edit_mesh_face_rot_uv,
    VIEW3D_MT_edit_mesh_freestyle_face,
    VIEW3D_MT_edit_mesh_fill,
