...
class MakePillow(bpy.types.Operator):
    ...
    def execute(self, context):        # execute() is called by blender when running the operator.
        ...
        # The original script
       scene = context.scene
       bpy.ops.object.effector_add(type='FORCE', radius=1.0, view_align=False, enter_editmode=False, location=(0.0, 0.0, 0.0), rotation=(0.0, 0.0, 0.0), layers=(True, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
