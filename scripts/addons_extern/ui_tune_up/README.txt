...
SEQUENCER KEYBOARD LAYOUT:
R/L Arrows				Move 1 frame forward or backwards
Shift + R/L Arrows		Move x10 frames forward or backwards
Shift + Up/Dn Arrow 	Move cursor to selected clip tip or tail
Alt + Up/Dn/L/R 		Navigate clips
Alt + Shift + Up/Dn/L/R Adds clips to selection
Spacebar				Play/Stop Sequencer (Esc to cancel play and rewind)
G 						Move clips
Shift + S				Snaps clip's tip to cursor
Alt + S 				Snaps clip's tail to cursor
PageUp/PageDown 		Move the cursor to next/prev clip's tip or tail
I 						Trim video IN
O 						Trim video OUT
Alt + I/O 				Resets video In/Out
H/L 					Toggle Mute and Lock Clip
S 						Slip clip's content

Note: you have to enable these shortcuts by uncommenting the lines in data.json.
