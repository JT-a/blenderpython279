...
class MeshBrushProps(bpy.types.PropertyGroup):
    ...
    spacing = bpy.props.IntProperty(
        name="Spacing",
        description="Distance between dabs as a percentage of the brush's radius",
        default=25,
        min=1,
        soft_max=100,
        subtype='PERCENTAGE'
    ...
    backfacing_are_ignored = bpy.props.BoolProperty(
        ...
        description="Ignore vertices with normals pointing away from the brush.",
        default=False
    )
    ...
    radial_count = bpy.props.IntProperty(
        name="Radial Count",
        description="Number of radially symmetrical brushes per axis of symmetry",
        default=1,
        min=1,
        soft_max=12
    )
    symmetry_type = bpy.props.EnumProperty(
        name="Symmetry Type",
        description="The type of symmetry to employ in modifying the mesh object",
        default='MIRROR',
        items=[
