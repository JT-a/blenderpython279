                    ...
                    if len(obj.data.materials) > matIndex:
                        if obj.data.materials[matIndex] is not None:
                            if context.active_object.data.materials[matIndex].active_texture:
                                textureWidth = context.active_object.data.materials[matIndex].active_texture.image.size[
                                    0]
                                textureHeight = \
                                context.active_object.data.materials[matIndex].active_texture.image.size[1]
                                nX = f.normal.x
                                nY = f.normal.y
                                nZ = f.normal.z
                                if nX < 0:
