...
class TP_Panels_Preferences(AddonPreferences):
    ...
    tools_category_add = StringProperty(name = "TAB Category", description = "add name for a new category tab", default = 'T+', update = update_panel_position_add)
    tools_category_custom = StringProperty(name = "TAB Category", description = "add name for a new category tab", default = 'T+', update = update_panel_position_custom)
