...
class mesh_guided_duplication(bpy.types.Operator):
    ...
    def create_duplicates(self, context, coordinates):
        ...
        for c in coordinates:
            ...
            if props.rotate_duplicates:
                if props.rotation_axis[0]:
                    o.rotation_euler.x = c['no'][0]
                if props.rotation_axis[1]:
                    o.rotation_euler.y = c['no'][1]
                if props.rotation_axis[2]:
                    o.rotation_euler.z = c['no'][2]
