...
def draw_cursor_origin_tools(context, layout):
    ...
    Display_Snap_to = context.user_preferences.addons[__package__].preferences.tab_snap_to
    ...
    Display_Origin_to = context.user_preferences.addons[__package__].preferences.tab_origin_to
...
def draw_scale_align_tools(context, layout):
    ...
    Display_Align_to_Axis = context.user_preferences.addons[__package__].preferences.tab_align_to_axis
    if Display_Align_to_Axis == 'on':
        ...
        Display_Align_Tools = context.user_preferences.addons[__package__].preferences.tab_align_tools
...
def draw_align_tools_panel_layout(self, context, layout):
        ...
        Display_Snap_Set = context.user_preferences.addons[__package__].preferences.tab_snap_set
        ...
        if context.mode == 'OBJECT':
            ...
            if Display_Snap_to == 'on':
                ...
                row.operator("tp_ops.throughselected", text=" ", icon_value=button_cursor_center_offset_obm.icon_id)
            ...
            Display_Zero_to = context.user_preferences.addons[__package__].preferences.tab_zero_to
            ...
            Display_Snap_Tools = context.user_preferences.addons[__package__].preferences.tab_snap_tools
            ...
            Display_Mirror_Obm = context.user_preferences.addons[__package__].preferences.tab_mirror_obm
            ...
            Display_YLook_Tools = context.user_preferences.addons[__package__].preferences.tab_ylook_tools
        ...
        if context.mode == 'EDIT_MESH':
            ...
            Display_Looptools_Edm = context.user_preferences.addons[__package__].preferences.tab_looptools_edm
            ...
            Display_Mirror_Edm = context.user_preferences.addons[__package__].preferences.tab_mirror_edm
            ...
            Display_Edge_Align = context.user_preferences.addons[__package__].preferences.tab_edge_align
            ...
            Display_AutoMirror = context.user_preferences.addons[__package__].preferences.tab_automirror_edm
            if Display_AutoMirror == 'on':
        ...
        if context.mode == 'EDIT_LATTICE':
            ...
            Display_Mirror_Lat = context.user_preferences.addons[__package__].preferences.tab_mirror_lat
        ...
        if context.mode == 'EDIT_CURVE' or context.mode == 'EDIT_SURFACE':
            ...
            Display_Mirror_Curve = context.user_preferences.addons[__package__].preferences.tab_mirror_curve
        ...
        if Display_Transform == 'on':
            ...
            if context.mode == 'OBJECT':  
                ...
                row = box.row(1)
                if tpw.display_apply:            
                    row.prop(tpw, "display_apply", text="", icon="MANIPUL")
                else:
                    row.prop(tpw, "display_apply", text="", icon="MANIPUL")
